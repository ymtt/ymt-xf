function clickconsultation(title,content,points,expert){
        ...
        var url='http://101.204.236.5/fw?controller=com.xfsm.action.ChatAction&t=app&m=startChat';
           if(session==null){
...
function getsubclass(pid){
     var url='http://101.204.236.5/fw?controller=com.xfsm.action.TypeAction&t=app&m=st&type=PUB_XXF_ZXFL&bt=tree';
        $.ajax({
            type:'get',
            dataType:'json',
            url:url,
